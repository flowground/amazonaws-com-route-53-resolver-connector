# ![LOGO](logo.png) Amazon Route 53 Resolver MSP Connector

## Description

A generated MSP connector for the Amazon Route 53 Resolver API (version 2018-04-01).
...
flowground :- Telekom iPaaS / amazonaws-com-route-53-resolver-connector<br/>
